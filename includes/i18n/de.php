...
$i18n = [
    ...
    'last_date'    => "Letzte Zahlung",
    'last_date_str'    => "Läuft ab in",
    ...
    'savings' => "Monatlicher Sparplan",
    'general' => "Pauschalbeträge",
    'monthly_cost'    => "Monatliche Kosten (tatsächlich)",
    'monthly_cost_pure'    => "Monatliche Kosten",
    ...
    "archive_afterdays"  => "Archivierung",
    "archive_afterdays_info"     => "Gekündigte (letzte Zahlung) Abos werden nach x Tagen archiviert.",
    ...
    "save_category_savingsplan"   => "Als Sparplan-Kategorie setzen (wird in der Statistik gesondert berücksichtigt)",
    "save_category_general"   => "Als Pauschalbeträge-Kategorie setzen (wird in der Statistik gesondert berücksichtigt)",
    ...
    "apikey_info"      => "Hiermit erhälst du Zugriff auf den Endpunkt /api mittels einem Bearer token (Authorization)",
